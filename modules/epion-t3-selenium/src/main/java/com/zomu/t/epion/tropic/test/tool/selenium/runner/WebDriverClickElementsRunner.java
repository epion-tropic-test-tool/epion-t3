...
import com.zomu.t.epion.tropic.test.tool.selenium.command.WebDriverClickElements;
...
@Slf4j
public class WebDriverClickElementsRunner extends AbstractCommandRunner<WebDriverClickElements> {

    /**
     * {@inheritDoc}
     */
    @Override
    public CommandResult execute(WebDriverClickElements command, Logger logger) throws Exception {
