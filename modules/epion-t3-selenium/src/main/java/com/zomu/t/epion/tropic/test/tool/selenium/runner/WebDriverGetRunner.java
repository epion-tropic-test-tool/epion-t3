...
public class WebDriverGetRunner implements CommandRunner<WebDriverGet> {
    @Override
    public void execute(WebDriverGet process, Map<String, Object> globalScopeVariables, Map<String, Object> scenarioScopeVariables, Logger logger) throws Exception {
