package com.zomu.t.epion.tropic.test.tool.core.initialize;
...
public class InitializeEpion {
    ...
    private static final String TEMPLATE_SCENERIO_PACKAGE = "com.zomu.t.epion.tropic.test.tool.scenario.template";
